---
module: vm
owns: [thistle64-execution, thistle32-compatibility, sparse-memory, native-syscall-bridge]
...
The loops yield every 4096 instructions and check cancellation on every
instruction. `THISTLE_FUEL=0` disables the configurable instruction guard.
